...
static int kageant_openssh_get(void)
{
...
static void kageant_openssh_set(int on)
{
    HKEY hk;
...
static char *kageant_ssh_path(const char *leaf)
{
...
static void kageant_write_identityagent(FILE *fp, const char *pipename)
{
...
static void kageant_openssh_apply(int on)
{
